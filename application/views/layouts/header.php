            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="<?php echo base_url();?>">
                        <img style='height: 50px;' src="<?php echo base_url()?>/assets/template/images/logo.png"
                            alt="logo" />
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text"><span
                                class="text-black fw-bold"><?php echo $this->session->userdata('nama')?></span></h1>
                        <!-- <h3 class="welcome-sub-text">Your performance summary this week </h3> -->
                    </li>
                    <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                        <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <img class="img-xs rounded-circle"
                                src="https://account.kemenkeu.go.id/manage/Uploads/Thumbnails/<?php echo str_replace(' ','',$_SESSION['nip18'])?>.jpg"
                                alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <div class="dropdown-header text-center">
                                ...
                                <img class="img-md rounded-circle" width='80px'
                                    src="https://account.kemenkeu.go.id/manage/Uploads/Thumbnails/<?php echo str_replace(' ','',$_SESSION['nip18'])?>.jpg"
                                    alt="">
                                ...
                                <p class="my-1 font-weight-semibold"><?php echo $this->session->userdata('jabatan')?>
                                </p>
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img
                                        src="<?php echo base_url()?>/assets/template/images/faces/face1.jpg"
                            ...
                            <li class="list">
                                <div class="profile"><img
                                        src="<?php echo base_url()?>/assets/template/images/faces/face2.jpg"
                            ...
                            <li class="list">
                                <div class="profile"><img
                                        src="<?php echo base_url()?>/assets/template/images/faces/face3.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Daniel Russell</p>
                                    <p>Available</p>
                            ...
                            <li class="list">
                                <div class="profile"><img
                                        src="<?php echo base_url()?>/assets/template/images/faces/face4.jpg"
                                        alt="image"><span class="offline"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img
                                        src="<?php echo base_url()?>/assets/template/images/faces/face5.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img
                                        src="<?php echo base_url()?>/assets/template/images/faces/face6.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Sarah Graves</p>
                                    <p>Available</p>

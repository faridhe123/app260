...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url() ?>/assets/template/vendors/simple-line-icons/css/simple-line-icons.css">
...
<body>
                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                <img style='width:130px' src="<?php echo base_url() ?>/assets/template/images/logo.png"
                                    alt="logo">
                            ...
                            <form id='login' class="form-horizontal pt-3k" method='POST'
                                action='<?php echo base_url('login/getlogin')?>'>
                                <?php if(isset($_GET['redirect_to'])){?>
                                <input type="hidden" name="redirect_to" id="redirect_to" class="form-control"
					...
					if(!empty($info)){ ?>
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong>Username / password salah!</strong><br />Hubungi administrator jika lupa
                                    password.
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
    ...
    <script src="<?php echo base_url() ?>/assets/template/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js">
    </script>
